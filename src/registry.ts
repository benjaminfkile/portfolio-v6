 ...
 *
 * `status`, `blog`, `now_playing`, (v1.2) `duolingo` and `github`, and (v1.3)
 * `ops` are live sections (§3.5): their config is in the snapshot but their data
 * is fetched at runtime by the component.
 */
